  ...
  return (
    <div className={style.page}>
      <div className={style.page__nav}>
        <span className={style.page__navCnt}>
          <BackButton onClick={() => router.back()} />
          <Logo type={LogoTypeEnum.INNER} />
        </span>
      </div>
      <div className={style.page__content}>
        <h1 className={cn('block-title', style.page__title)}>
          Политика в отношении обработки персональных данных
        </h1>
        <h2 className={style.page__sectionTitle}>1. Общие положения</h2>
        <div className={style.page__section}>
          <p>
            ...
            обеспечению безопасности персональных данных, предпринимаемые АО ПСК
            «СИБУР-ТИЗОЛ» (далее – Оператор).
          </p>
          <p>
          ...
          <p>
            ...
            <a href='https://dom-king.ru' target='_blank'>
              https://dom-king.ru
            </a>
            .
          </p>
        ...
        <h2 className={style.page__sectionTitle}>
        ...
        <div className={style.page__section}>
          ...
          <p>5.4. Адреса и номера мессенджеров.</p>
          <p>
        ...
        <div className={style.page__section}>
          ...
          <p>
            – любое информирование Пользователя по переданным контактным данным.
          </p>
          <p>
            ...
            электронной почты с пометкой «Отказ от уведомлений о новых продуктах
        ...
        <div className={style.page__section}>
          ...
          <p>
            ...
            <a href='https://dom-king.ru/privacy-policy' target='_blank'>
              https://dom-king.ru/privacy-policy/
            </a>
            .
          </p>
        </div>
